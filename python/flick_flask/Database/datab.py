...
def set_seller(Email="email", passwd="password", firstName="FirstName", lastName="LastName", department="department"):
	...
	ses.add_all([Seller(Id=Email, passwd=generate_password_hash(passwd), Seller_firstname=firstName, Seller_lastname=lastName, department=department)])
	ses.commit()
	return 0
